//Source:: https://github.com/ikarienator/chrome-app-samples/blob/Multicast/multicast/MulticastSocket.js
/**
 *
 * @param {Object} config
...
function MulticastSocket(config) {
  ...
  mc_proto.arrayBufferToString8 = function (arrayBuffer) {
    // UTF-16LE
  ...
  mc_proto.stringToArrayBuffer8 = function (string) {
    // UTF-16LE
    var buf = new ArrayBuffer(string.length * 2);
  ...
  mc_proto.sendDiagram = function (message, callback, errCallback) {
    if (typeof message === 'string') {
      message = this.stringToArrayBuffer8(message);
    }
