...
class Message(object):
    ...
    def getChecksum(self):
        data = len(self.getPayload()).to_bytes(1, byteorder='little')
        data += self.getType().to_bytes(1, byteorder='little')
        data += b''.join(self.getPayload())
    ...
    def decode(self, raw):
        ...
        if self.getChecksum() != raw[length + 3].to_bytes(1, byteorder='little'):
...
class ChannelMessage(Message):
    ...
    def setChannelNumber(self, number):
        ...
        self.payload[0] = number.to_bytes(1, byteorder='little')
...
class ChannelAssignMessage(ChannelMessage):
    ...
    def setChannelType(self, type_):
        self.payload[1] = type_.to_bytes(1, byteorder='little')

    def getNetworkNumber(self):
        return ord(self.payload[2])

    def setNetworkNumber(self, number):
        self.payload[2] = number.to_bytes(1, byteorder='little')
...
class ChannelIDMessage(ChannelMessage):
    ...
    def setDeviceType(self, device_type):
        self.payload[3] = device_type.to_bytes(1, byteorder='little')

    def getTransmissionType(self):
        return ord(self.payload[4])

    def setTransmissionType(self, trans_type):
        self.payload[4] = trans_type.to_bytes(1, byteorder='little')
...
class ChannelSearchTimeoutMessage(ChannelMessage):
    ...
    def setTimeout(self, timeout):
        self.payload[1] = timeout.to_bytes(1, byteorder='little')
...
class ChannelFrequencyMessage(ChannelMessage):
    ...
    def setFrequency(self, frequency):
        self.payload[1] = frequency.to_bytes(1, byteorder='little')
...
class ChannelTXPowerMessage(ChannelMessage):
    ...
    def setPower(self, power):
        self.payload[1] = power.to_bytes(1, byteorder='little')


class NetworkKeyMessage(Message):
    def __init__(self, number=0x00, key=b'\x00' * 8):
        Message.__init__(self, type_=MESSAGE_NETWORK_KEY, payload=b'\x00' * 9)
...
class TXPowerMessage(Message):
    def __init__(self, power=0x00):
        Message.__init__(self, type_=MESSAGE_TX_POWER, payload=b'\x00\x00')
        self.setPower(power)
...
class ChannelRequestMessage(ChannelMessage):
    ...
    def setMessageID(self, message_id):
        ...
        self.payload[1] = message_id.to_bytes(1, byteorder='little')
...
class ChannelEventMessage(ChannelMessage):
    ...
    def setMessageCode(self, message_code):
        ...
        self.payload[2] = message_code.to_bytes(1, byteorder='little')


# Requested response messages
class StartupMessage(Message):
    def __init__(self, number=0x00):
        Message.__init__(self, type_=MESSAGE_STARTUP, payload=b'\x00' * 9)
...
class ChannelStatusMessage(ChannelMessage):
    ...
    def setStatus(self, status):
        ...
        self.payload[1] = status.to_bytes(1, byteorder='little')


class VersionMessage(Message):
    def __init__(self, version='\x00' * 9):
        Message.__init__(self, type_=MESSAGE_VERSION, payload=b'\x00' * 9)
...
class CapabilitiesMessage(Message):
    def __init__(self, max_channels=0x00, max_nets=0x00, std_opts=0x00,
        ...
        Message.__init__(self, type_=MESSAGE_CAPABILITIES, payload=b'\x00' * 4)
    ...
    def setMaxChannels(self, num):
        ...
        self.payload[0] = num.to_bytes(1, byteorder='little')
    ...
    def setMaxNetworks(self, num):
        ...
        self.payload[1] = num.to_bytes(1, byteorder='little')
    ...
    def setStdOptions(self, num):
        ...
        self.payload[2] = num.to_bytes(1, byteorder='little')
    ...
    def setAdvOptions(self, num):
        ...
        self.payload[3] = num.to_bytes(1, byteorder='little')
    ...
    def setAdvOptions2(self, num):
        ...
        self.payload[4] = num.to_bytes(1, byteorder='little')
