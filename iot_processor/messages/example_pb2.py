...
_PERSON_PHONETYPE = _descriptor.EnumDescriptor(
  name='PhoneType',
  full_name='iot_processor.messages.Person.PhoneType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PERSON_PHONENUMBER = _descriptor.Descriptor(
  name='PhoneNumber',
  full_name='iot_processor.messages.Person.PhoneNumber',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='number', full_name='iot_processor.messages.Person.PhoneNumber.number', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='iot_processor.messages.Person.PhoneNumber.type', index=1,
...
_PERSON = _descriptor.Descriptor(
  name='Person',
  full_name='iot_processor.messages.Person',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='iot_processor.messages.Person.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='id', full_name='iot_processor.messages.Person.id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='email', full_name='iot_processor.messages.Person.email', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='phones', full_name='iot_processor.messages.Person.phones', index=3,
...
_ADDRESSBOOK = _descriptor.Descriptor(
  name='AddressBook',
  full_name='iot_processor.messages.AddressBook',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='people', full_name='iot_processor.messages.AddressBook.people', index=0,
...
Person = _reflection.GeneratedProtocolMessageType('Person', (_message.Message,), {
  ...
  'PhoneNumber' : _reflection.GeneratedProtocolMessageType('PhoneNumber', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:iot_processor.messages.Person.PhoneNumber)
    })
  ,
  'DESCRIPTOR' : _PERSON,
  '__module__' : 'example_pb2'
  # @@protoc_insertion_point(class_scope:iot_processor.messages.Person)
  })
